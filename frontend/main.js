document.addEventListener('DOMContentLoaded', () => {
    ...
    const PRODUCT_API_BASE_URL = "http://" + '_PRODUCT_API_URL_' + ":8000";
    const ORDER_API_BASE_URL = "http://" + '_ORDER_API_URL_' + ":8001";
    const CUSTOMER_API_BASE_URL = "http://" + '_CUSTOMER_API_URL_' + ":8002";
